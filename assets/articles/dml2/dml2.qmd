---
title: 'Double Machine Learning, Simplified: Part 2 - Targeting & the CATE'
jupyter: python3
toc: true
execute:
  cache: true
...
parallax_split_cover(
    ...
    kicker="Causal ML • Heterogeneous Effects",
    title='Double Machine Learning, Simplified: Part 2 - Targeting & the CATE',
    subtitle="Learn how to utilize DML for estimating idiosyncratic treatment effects to enable personalized targeting.",
    chips=("CATE", "Linear DML", "Non-Parametric DML"),
    takeaways=(
    ...
    equation_latex=r"\tilde{y}=\tau(X)\,\tilde{T}+\varepsilon",
)
```
...
```
![](data/linear_dml_nonlinear_hist.webp)
...
```
![](data/linear_dml_nonlinear_line.webp)
...
```
![](data/nonparam_dml_nonlinear_hist.webp)
...
```
![](data/nonparam_dml_nonlinear_line.webp)
