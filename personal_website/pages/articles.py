...
def body():
    ...
    fwl = rx.link(
                    ...
                    rx.markdown(open("assets/text/articles/fwl.md", encoding="utf-8").read(),component_map=articles_page['markdown_style_block']),
                    rx.markdown('''<center> Understanding Linear Regression 
    ...
    logistic = rx.link(
                    ...
                    rx.markdown(open("assets/text/articles/logistic.md", encoding="utf-8").read(),component_map=articles_page['markdown_style_block']),
                    rx.markdown('''<center> Acquire a robust understanding of logit model 
    ...
    nm1 = rx.link(
                    ...
                    rx.markdown(open("assets/text/articles/nm1.md", encoding="utf-8").read(),component_map=articles_page['markdown_style_block']),
                    rx.markdown('''<center> Learn how to solve and utilize Newton's Method
    ...
    nm2 = rx.link(
                    ...
                    rx.markdown(open("assets/text/articles/nm2.md", encoding="utf-8").read(),component_map=articles_page['markdown_style_block']),
                    rx.markdown('''<center> Learn how to extend Newton's Method to 
    ...
    nm3 = rx.link(
                    ...
                    rx.markdown(open("assets/text/articles/nm3.md", encoding="utf-8").read(),component_map=articles_page['markdown_style_block']),
                    rx.markdown('''<center> Learn how to apply optimization & econometric techniques to 
    ...
    tsne = rx.link(
                    ...
                    rx.markdown(open("assets/text/articles/tsne.md", encoding="utf-8").read(),component_map=articles_page['markdown_style_block']),
                    rx.markdown('''<center> Acquire a deep understanding of the inner workings of t-SNE
    ...
    dml1 = rx.link(
                    ...
                    rx.markdown(open("assets/text/articles/dml1.md", encoding="utf-8").read(),component_map=articles_page['markdown_style_block']),
                    rx.markdown('''<center> Learn how to utilize DML in causal inference tasks </center>''')
                    )
                ),
                padding_x='3em',
                padding_bottom='3em'
    ...
    dml2 = rx.link(
                    ...
                    rx.markdown(open("assets/text/articles/dml2.md", encoding="utf-8").read(),component_map=articles_page['markdown_style_block']),
                    rx.markdown('''<center> Learn how to utilize DML for estimating individual
    ...
    intro = rx.box(
        container(**articles_page['body_container_style']),
            rx.hstack(dml2, dml1, tsne, display=["none", "none", "none", "none", "flex", "flex"], padding_bottom="5em"),
            rx.hstack(nm3, nm2, nm1, display=["none", "none", "none", "none", "flex", "flex"], padding_bottom="5em"),
            rx.hstack(logistic, fwl, display=["none", "none", "none", "none", "flex", "flex"], padding_bottom="5em"),
            rx.vstack(dml2, dml1, tsne, nm3, nm2, nm1, logistic, fwl, display=["flex", "flex", "flex", "flex", "none", "none"]),
            padding_x="5em"
            )
